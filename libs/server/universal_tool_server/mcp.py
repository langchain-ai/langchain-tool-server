...
class MCPStreamableHandler:
    ...
    def create_response(self, request_id: Any, result: Any, session: Optional[MCPSession] = None) -> JSONResponse:
    ...
    def create_error(self, request_id: Any, code: int, message: str, session: Optional[MCPSession] = None) -> JSONResponse:
    ...
    async def handle_tools_list(self, session: MCPSession, body: dict) -> JSONResponse:
        ...
        # Convert to MCP format - only return latest version of each tool
        tools_list = []
        seen_names = set()
    ...
    async def handle_tools_call(self, session: MCPSession, body: dict) -> JSONResponse:
        ...
        try:
            ...
            # Execute the tool
            response = await self.tool_handler.call_tool(call_tool_request, request=None)
